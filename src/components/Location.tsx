  ...
  return (
    <section className="py-12 sm:py-16 px-4 bg-[#F7F7F7]" id="ubicacion">
      <div className="w-full flex justify-center items-center flex-col">
        ...
        <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:w-4/5 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-14 items-start">
          {/* Map */}
          ...
          <div className="w-full flex flex-col justify-center space-y-6 sm:space-y-8 py-2">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">farmacianuevaparana@hotmail.comr</p>
              </div>
            </div>
          </div>
        </div>
